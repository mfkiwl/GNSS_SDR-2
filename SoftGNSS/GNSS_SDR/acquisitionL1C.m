function acqResults = acquisitionL1C(longSignal, settings)
...
% Generate all L1C codes and sample them according to the sampling freq.
...
% L1C code phases of detected signals
...
%% Correlate signals ======================================================   
    ...
    L1CCodeFreqDom = conj(fft(L1CCodesTable(PRN, :)));
    ...
    for frqBinIndex = 1:numberOfFrqBins
        ...
        %domain)
        convCodeIQ1 = IQfreqDom1 .* L1CCodeFreqDom;
        convCodeIQ2 = IQfreqDom2 .* L1CCodeFreqDom;
