...
try
    ...
    disp('  (run setSettings or change settings in "initSettingsL1C.m" to reconfigure)')    
    return;
end
    
disp('  Raw IF data plotted ')
disp('  (run setSettings or change settings in "initSettingsL1CD.m" to reconfigure)')
disp(' ');
