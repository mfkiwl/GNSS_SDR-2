...
%% Acquisition ============================================================
    ...
    if ((settings.skipAcquisition == 0) || ~exist('acqResults', 'var'))
        ...
        % Read data for acquisition. 20ms of signal are needed for the fine
        % frequency estimation (20ms L1C code)
        ...
        acqResults = acquisitionL1C(data, settings);
...
%% Calculate navigation solutions =========================================
    ...
    navBits = postNavigationL1C(trackResults, settings);
    disp('   Processing is complete for this data block');

%% Plot all results ===================================================
    disp ('   Ploting results...');
    if settings.plotTracking
        plotTrackingL1C(strfind([trackResults.status],'T'), trackResults, settings);
    end
