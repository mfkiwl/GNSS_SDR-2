...
%% Acquisition ============================================================
    ...
    if ((settings.skipAcquisition == 0) || ~exist('acqResults', 'var'))
        ...
        % frequency estimation (20ms L1CD code)
        ...
        acqResults = acquisitionL1CD(data, settings);
...
%% Track the signal =======================================================
    ...
    [trackResults, channel] = trackingL1CD(fid, channel, settings);
...
%% Plot all results ===================================================
    ...
    if settings.plotTracking
        plotTrackingL1CD(strfind([trackResults.status],'T'), trackResults, settings);
    end
